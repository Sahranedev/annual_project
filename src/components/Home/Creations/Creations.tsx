...
export default async function Creations() {
  const response = await fetch(
    `http://localhost:1337/api/home-page?populate=creations&populate=creations.creations&limit=4&populate=creations.creations.images&populate=creations.creations.creation_categories`
  );
